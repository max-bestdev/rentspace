...
//	}
	...
	log.info("FreeBoardService.getRowAmountTotal()에 전달된 FreeBoardPagingDTO: " + freeBoardPagingDTO);
	return freeBoardMapper.selectRowAmountTotal(freeBoardPagingDTO);
	}	
	...
	public List<FreeBoardVO> getBoardList(FreeBoardPagingDTO freeBoardPagingDTO) {
		log.info("FreeBoardService.getBoardList() 실행");
		return freeBoardMapper.selectFreeBoardList(freeBoardPagingDTO);
	}
