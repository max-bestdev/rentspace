    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${contextPath}/list">RENTSPACE</a>
            </div>
            <!-- /.navbar-header -->

			<!-- search bar -->
           <div class="input-group custom-search-form" style="float: left; width: 15%; padding: 8px 0px">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="sidebar-search">
						...
						<li><a id="freeLogout" href="${contextPath}/login">
						<i class="fa fa-sign-in fa-fw"></i> Sign in</a><!-- a 링크 수정, Sign in 으로 수정 -->
						</li>
						<li class="divider"></li>
						<li><a id="freeLogout" href="${contextPath}/logout">
